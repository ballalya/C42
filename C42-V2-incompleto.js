class Game {
  ...
  start() {
    ...
    car1.scale = 0.07;
    car1.addImage("blast", kaboom);

    car2 = createSprite(width / 2 + 100, height - 100);
    car2.addImage("car2", car2_img);
    car2.scale = 0.07;
    car2.addImage("blast", kaboom);
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        if (index === player.index) {
          ...
          this.handleObstacleCollisionWithCarB(index);
          if(player.life <= 0){
            this.blast = true;
            this.playerMoving = false;
          }
  ...
  handleObstacleCollisionWithCarB(index) {
    if(index === 1){
